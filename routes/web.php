...
// IKEA
Route::native('/ikea', \App\NativeComponents\IkeaHome::class)->name('ikea.home');
...
// Facebook
Route::native('/facebook', \App\NativeComponents\FacebookFeed::class)->name('facebook.feed');
...
// Instagram
Route::native('/instagram', \App\NativeComponents\InstagramFeed::class)->name('instagram.feed');
...
// Spotify
Route::native('/spotify', \App\NativeComponents\SpotifyHome::class)->name('spotify.home');
...
// YouTube
Route::native('/youtube', \App\NativeComponents\YouTubeHome::class)->name('youtube.home');
